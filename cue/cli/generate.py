...
def main(config_yaml):
    config = cue.cli.config.load_config(config_yaml, config_type=cue.cli.config.CONFIG_TYPE.GENERATE)
    ...
    Parallel(n_jobs=config.n_cpus)(delayed(generate)(config, chr_name_chunks[i]) for i in range(config.n_cpus))
